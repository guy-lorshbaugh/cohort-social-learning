    ...
    for (var choice of choices) {
        if (!exclude.includes(choice.getAttribute("title"))) {
            choice.addEventListener('mousedown', event => {
                ...
                emoji.innerHTML = event.target.outerHTML;
                emojiTextarea.innerHTML += emoji.innerHTML;
                }
            )
        }
    }
...
//     // TRY ADDING OBJECT ATTRIBUTES BY HAND??
//     // Object.assign(contents, element);
//     // console.log(contents);
//     // contents.className = "";
//     // // contents.classList.add("emoji")
//     // return contents
// }
